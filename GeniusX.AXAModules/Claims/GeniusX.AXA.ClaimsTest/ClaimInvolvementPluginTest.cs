...
{
    [TestClass]
    public class ClaimInvolvementPluginTest : ComponentPluginBaseTest<ClaimInvolvementPlugin>
    {
        ...
        {
            target = new ClaimInvolvementPlugin();
            ...
            DirtyProperty dirtyProperty = new DirtyProperty(10, -1);
            claimNI.DirtyPropertyList.Add("NameID", dirtyProperty);
        ...
        [TestMethod]
        public void OnDeleteRenameClaimDetailTitleTest()
        {
            ClaimDetailToClaimInvolvementLinkPlugin linkPlugin = new ClaimDetailToClaimInvolvementLinkPlugin();
            linkPlugin.ProcessComponent(this.linkComponent, ProcessInvocationPoint.Created, 0, new ProcessParameters() { Alias = string.Empty, TransactionInvocationPoint = TransactionInvocationPoint.PostComplete });
            Assert.AreEqual("AD - IDS Test", this.headerComponent.ClaimDetails.First().ClaimDetailTitle);
            ProcessInvocationPoint point = ProcessInvocationPoint.Delete;
        ...
        [TestMethod]
        public void OnComponentRenameClaimDetailTitleTest()
        {
